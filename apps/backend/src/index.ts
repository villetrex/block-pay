...
import { hiddenDirectiveTransformer } from './directives/hidden';
...
const schema = addMocksToSchema({
  schema: hiddenDirectiveTransformer(
    authDirective(upperDirectiveTransformer(makeExecutableSchema({ typeDefs, resolvers }), 'upper'), 'auth'),
    'hidden',
  ),
